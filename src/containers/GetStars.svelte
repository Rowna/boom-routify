<script>
  ...
  // Prop: durchschnittsrating ("average rating")
  export let avgRating = 4;
...
<p class="sternebewertung">
  ...
  <label for="stern5" title="5 Sterne" on:click={(avgRating = 4)}
    >5 Sterne</label
  >
  <input type="radio" id="stern4" name="bewertung" value="4" />
  <label for="stern4" title="4 Sterne">4 Sterne</label>
  <input type="radio" id="stern3" name="bewertung" value="3" />
  <label for="stern3" title="3 Sterne">3 Sterne</label>
  <input type="radio" id="stern2" name="bewertung" value="2" />
  <label for="stern2" title="2 Sterne">2 Sterne</label>
  <input type="radio" id="stern1" name="bewertung" value="1" />
  <label for="stern1" title="1 Stern">1 Stern</label>
